...
enumerate() в Python — это встроенная функция, которая позволяет в цикле for одновременно получать и
индекс элемента, и само значение из итерируемого объекта (списка, кортежа, строки),
избавляя от необходимости вручную создавать счетчик. Она возвращает итератор, выдающий кортежи вида (индекс, элемент)
